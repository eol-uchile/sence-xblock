...
DJANGO_SETTINGS_MODULE=lms.envs.test EDXAPP_TEST_MONGO_HOST=mongodb pytest -s -vvv --no-cov sence/integrations/tests_login_interface_uchileedxlogin.py
...
mkdir -p test_root
ln -s /openedx/staticfiles ./test_root/
DJANGO_SETTINGS_MODULE=lms.envs.test EDXAPP_TEST_MONGO_HOST=mongodb pytest -s -vvv --no-cov sence/integrations/tests_login_interface_eol_sso_login.py
